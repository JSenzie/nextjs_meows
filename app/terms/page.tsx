...
function Terms() {
  return (
    <div className="space-y-4 px-12 py-4">
      ...
      <h2 className="text-xl">SECTION 1 - ONLINE STORE TERMS</h2>
      ...
      <h2 className="text-xl">SECTION 2 - GENERAL CONDITIONS</h2>
      ...
      <h2 className="text-xl">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
      ...
      <h2 className="text-xl">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
      ...
      <h2 className="text-xl">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
      ...
      <h2 className="text-xl">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
      ...
      <h2 className="text-xl">SECTION 7 - OPTIONAL TOOLS</h2>
      ...
      <h2 className="text-xl">SECTION 8 - THIRD-PARTY LINKS</h2>
      ...
      <h2 className="text-xl">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
      ...
      <h2 className="text-xl">SECTION 10 - PERSONAL INFORMATION</h2>
      ...
      <h2 className="text-xl">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
      ...
      <h2 className="text-xl">SECTION 12 - PROHIBITED USES</h2>
      ...
      <h2 className="text-xl">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
      ...
      <h2 className="text-xl">SECTION 14 - INDEMNIFICATION</h2>
      ...
      <h2 className="text-xl">SECTION 15 - SEVERABILITY</h2>

      <p>In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.</p>

      <h2 className="text-xl">SECTION 16 - TERMINATION</h2>
      ...
      <h2 className="text-xl">SECTION 17 - ENTIRE AGREEMENT</h2>
      ...
      <h2 className="text-xl">SECTION 18 - GOVERNING LAW</h2>
      ...
      <h2 className="text-xl">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>

      <p>You can review the most current version of the Terms of Service at any time at this page. We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.</p>

      <h2 className="text-xl">SECTION 20 - CONTACT INFORMATION</h2>
